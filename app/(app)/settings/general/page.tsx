...
import { getEffectiveContentPreferences, isVacationModeActive, requireUser } from "@/domains/users/server";
...
export default async function GeneralSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        <h2 className="font-heading text-lg font-semibold text-foreground">Vacation</h2>
        <div className="mt-2">
