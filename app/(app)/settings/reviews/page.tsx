...
export default async function ReviewSettingsPage() {
  ...
  const preferences = await getReviewPreferences(
    user.id,
    ...
    <div className="flex flex-col gap-6">
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Choose how grammar and vocabulary reviews are presented. Changes
          affect your next review session, not one already open.
        </p>
        <div className="mt-4">
          <GrammarReviewTypeSelect
            initialValue={preferences.grammarReviewType}
          />
        </div>
        <div className="mt-2">
          <VocabularyReviewTypeSelect
            initialValue={preferences.vocabularyReviewType}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Control the optional aid available before you answer a review,
          separately for grammar and vocabulary.
        </p>
        <div className="mt-4">
          <HintModeSelect
            contentType="grammar"
            initialValue={preferences.grammarHintMode}
          />
        </div>
        <div className="mt-2">
          <HintOrderSelect
            contentType="grammar"
            initialValue={preferences.grammarHintOrder}
          />
        </div>
        <div className="mt-2">
          <HintModeSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularyHintMode}
          />
        </div>
        <div className="mt-2">
          <HintOrderSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularyHintOrder}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Presentation preferences for the review session itself.
        </p>
        <div className="mt-4">
          <ReviewUiToggle
            field="autoplayAudio"
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          How far an incorrect review sets an item back. Correct reviews always
          advance normally, regardless of this setting.
        </p>
        <div className="mt-4">
          <SrsStrictnessSelect
            contentType="grammar"
            initialValue={preferences.grammarSrsStrictness}
          />
        </div>
        <div className="mt-2">
          <SrsStrictnessSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularySrsStrictness}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          How far out a correct review is scheduled next. Changing your SRS
          interval only affects reviews scheduled from this point forward —
          reviews that already have a due time keep their existing due time.
        </p>
        <div className="mt-4">
          <SrsIntervalModeSelect
            contentType="grammar"
            initialValue={preferences.grammarSrsIntervalMode}
          />
        </div>
        <div className="mt-2">
          <SrsIntervalModeSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularySrsIntervalMode}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Applied after your SRS interval is calculated, rounding the resulting
          due time forward. One setting for both grammar and vocabulary.
        </p>
        <div className="mt-4">
          <ReviewQueueTimingSelect
            initialValue={preferences.reviewQueueTiming}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          When on, an item that reaches Fluent keeps coming back for a
          maintenance review every 6 months. Turning either off ends reviews
          outright for items at Fluent in that category — turning it back on
          picks up a maintenance schedule from when each item first became
          Fluent.
        </p>
        <div className="mt-4">
          <FluentModeToggle
            contentType="grammar"
            initialValue={preferences.grammarFluentMode}
          />
          <FluentModeToggle
            contentType="vocabulary"
            initialValue={preferences.vocabularyFluentMode}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          A missed sentence in a normal review can spin up a short, separate
          Ghost review to reinforce it — never affecting the item&apos;s own
          normal SRS stage.
        </p>
        <div className="mt-4">
          <GhostModeSelect
            contentType="grammar"
            initialValue={preferences.grammarGhostMode}
          />
        </div>
        <div className="mt-2">
          <GhostModeSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularyGhostMode}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          A Leech is an item with a history of repeated difficulty, calculated
          from your normal review performance — Ghost Reviews never count toward
          it.
        </p>
        <div className="mt-4">
          <MinimumLeechStageSelect
            contentType="grammar"
            initialValue={preferences.grammarMinimumLeechStage}
          />
        </div>
        <div className="mt-2">
          <MinimumLeechStageSelect
            contentType="vocabulary"
            initialValue={preferences.vocabularyMinimumLeechStage}
          />
        </div>
      </div>
    </div>
