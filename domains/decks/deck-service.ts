...
export async function getDeck(input: {
  userId: string;
  languageId: string;
  deckId: string;
...
export async function listEligibleDeckItems(input: {
  ...
  return repository.getEligibleDeckItems(db, {
    ...input,
    limit: DECK_ITEM_PICKER_LIMIT,
  });
}
...
export async function createPersonalDeck(
  input: mutations.CreatePersonalDeckInput,
) {
...
export async function updatePersonalDeckDetails(
  input: mutations.UpdatePersonalDeckDetailsInput,
) {
  await checkRateLimit("deck-mutation", input.userId);
...
export async function addPersonalDeckItems(
  input: mutations.AddPersonalDeckItemsInput,
) {
  await checkRateLimit("deck-mutation", input.userId);
...
export async function removePersonalDeckItem(
  input: mutations.RemovePersonalDeckItemInput,
) {
  await checkRateLimit("deck-mutation", input.userId);
...
export async function reorderPersonalDeckItems(
  input: mutations.ReorderPersonalDeckItemsInput,
) {
  await checkRateLimit("deck-mutation", input.userId);
...
export async function deletePersonalDeck(
  input: mutations.DeletePersonalDeckInput,
) {
  await checkRateLimit("deck-mutation", input.userId);
...
export async function listPublishedItemsForAdmin(input: {
  languageId: string;
  search?: string;
}) {
  return repository.getPublishedItemsForAdmin(db, {
    ...input,
    limit: DECK_ITEM_PICKER_LIMIT,
  });
}
...
export async function createPolyglotDeck(
  input: adminMutations.CreatePolyglotDeckInput,
) {
...
export async function updatePolyglotDeck(
  input: adminMutations.UpdatePolyglotDeckInput,
) {
  await checkRateLimit("deck-mutation", input.actorUserId);
...
export async function addPolyglotDeckItems(
  input: adminMutations.AddPolyglotDeckItemsInput,
) {
  await checkRateLimit("deck-mutation", input.actorUserId);
...
export async function removePolyglotDeckItem(
  input: adminMutations.RemovePolyglotDeckItemInput,
) {
  await checkRateLimit("deck-mutation", input.actorUserId);
...
export async function reorderPolyglotDeckItems(
  input: adminMutations.ReorderPolyglotDeckItemsInput,
) {
  await checkRateLimit("deck-mutation", input.actorUserId);
...
export async function deletePolyglotDeck(
  input: adminMutations.DeletePolyglotDeckInput,
) {
  await checkRateLimit("deck-mutation", input.actorUserId);
