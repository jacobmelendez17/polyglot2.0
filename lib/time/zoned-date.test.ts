...
describe("dateKeyInTimeZone", () => {
  it("matches the same instant's calendar date in the given zone", () => {
    ...
    expect(
      dateKeyInTimeZone(new Date("2026-09-18T22:40:00Z"), "America/Phoenix"),
    ).toBe("2026-09-18");
  });
  ...
  it("crosses a UTC calendar-date boundary for a zone ahead of UTC", () => {
    ...
    expect(
      dateKeyInTimeZone(new Date("2026-01-15T20:00:00Z"), "Asia/Kolkata"),
    ).toBe("2026-01-16");
  });
});
