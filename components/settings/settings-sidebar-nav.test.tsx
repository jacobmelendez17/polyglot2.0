...
describe("SettingsSidebarNav", () => {
  it("renders every settings section", () => {
    ...
    expect(screen.getByRole("link", { name: "Lessons" })).toHaveAttribute("href", "/settings/lessons");
    expect(screen.getByRole("link", { name: "Reviews" })).toHaveAttribute("href", "/settings/reviews");
    expect(screen.getByRole("link", { name: "Appearance" })).toHaveAttribute("href", "/settings/appearance");
    expect(screen.getByRole("link", { name: "Subscription" })).toHaveAttribute("href", "/settings/subscription");
    expect(screen.getByRole("link", { name: "Notifications" })).toHaveAttribute("href", "/settings/notifications");
    expect(screen.getByRole("link", { name: "API" })).toHaveAttribute("href", "/settings/api");
