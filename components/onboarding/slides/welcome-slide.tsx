 ...
 * nothing else.
 */
const GREETINGS = ["Hola", "Buenos días", "¿Qué tal?", "Bienvenido", "Gracias"] as const;

export function WelcomeSlide() {
  return (
    <div aria-hidden="true" className="relative flex h-56 w-full items-center justify-center sm:h-72">
      ...
      <span className="relative flex h-20 w-20 items-center justify-center rounded-full bg-primary/15 sm:h-24 sm:w-24">
        <span className="font-heading text-2xl font-semibold text-foreground sm:text-3xl">¡Hola!</span>
      </span>
...
const DELAY_CLASSES = ["", "ob-delay-1", "ob-delay-2", "ob-delay-3", "ob-delay-4"] as const;
