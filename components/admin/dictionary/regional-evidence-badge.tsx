...
const STATUS_CONFIG: Record<RegionalEvidenceStatus, { icon: typeof Check; className: string; describe: boolean }> = {
  recognized: { icon: Check, className: "text-state-success bg-state-success/15", describe: false },
  ...
  not_listed: { icon: CircleSlash, className: "text-muted-foreground bg-muted", describe: true },
  unknown: { icon: CircleHelp, className: "text-muted-foreground bg-muted/50", describe: false },
};
