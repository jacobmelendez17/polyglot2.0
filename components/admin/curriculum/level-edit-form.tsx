  ...
  return (
    <div className="flex flex-col gap-4 sm:max-w-xl">
      ...
      <label className="block text-sm">
        ...
        <Select value={status} onValueChange={(value) => setStatus(value as CurriculumStatus)}>
      ...
      <p className="text-sm text-muted-foreground">
        Contains {counts.vocabularyItems} vocabulary item{counts.vocabularyItems === 1 ? "" : "s"} across{" "}
        {counts.vocabularyGroups} group{counts.vocabularyGroups === 1 ? "" : "s"}, and {counts.grammarItems} grammar item
        {counts.grammarItems === 1 ? "" : "s"}. A level can hold any number of either — publishing it is your call.
      </p>
