 ...
 */
export function DeckPracticeComplete({
  deckId,
  questionsAttempted,
  questionsCorrect,
  summary,
}: DeckPracticeCompleteProps) {
  ...
  const shown =
    summary === null ? [] : group === "know" ? summary.know : summary.dontKnow;
      ...
      {summary ? (
        <div className="w-full space-y-3">
          ...
          <ToggleGroup
            ...
            className="w-full"
          >
            <ToggleGroupItem value="know">
              Know ({summary.knowCount})
            </ToggleGroupItem>
            <ToggleGroupItem value="dont_know">
              Don&rsquo;t Know ({summary.dontKnowCount})
            </ToggleGroupItem>
          </ToggleGroup>
